        ...
        <div className="space-y-5">
          ...
          <div className="grid gap-4">
            <UmbrellaTierCard
              ...
              isDeciding={exitTier === 'T0-PageRank' || exitTier === 'T0-URLhaus' || exitTier === 'T0-Umbrella'}
            />
            <WhitelistTierCard
              reasoning={result.reasoning}
            ...
            <DistilBertTierCard
              ...
              skipped={exitTier === 'T0-PageRank' || exitTier === 'T0-URLhaus' || exitTier === 'T0-Umbrella' || exitTier === 'T1-Whitelist'}
            />
            <HardSignalTierCard
